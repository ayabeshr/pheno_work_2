...
#include "/home/aya/Pheno_Work/analysis/macro/DemoAnalyzer.h"
#include "/home/aya/Pheno_Work/analysis/macro/newtree.h"
#include <TCanvas.h>
#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
...
void DemoAnalyzer::Loop()
{
   ...
   TFile* smHZZ4Mu   = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/final_analysis/output_demo_smHZZ4Mu.root"     , "RECREATE"); */
      // TFile* out_sm_HTobb      = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs/output_smHbb.root"        , "RECREATE");  
  ...
  /*==================================================================================*/ 
   ...
   TH1F *H_pt = new TH1F("H_pt", "BSM Heavy Higgs p_{T}", 500, 0, 500);
   ...
   for (Long64_t jentry = 0; jentry < nentries; jentry++)  
   {
	...
	met.met_phi.push_back(MET_phi);
	 ...
	 // TLorentzVector declarations 
         ...
         four_muons_beforeCut.muon2_eta.push_back(eta_mu2);
         ...
         /*^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
		  ...
		  if ( MuonLoose_Charge[mu1_idx] + MuonLoose_Charge[mu2_idx] == 0){  // mu1, mu2 
			 ...
			 // DR > 0.02 for each of the 4Muons
				...
				if ( BtagOk == 1){  
				  ...
				  //NEvents[14]++;				
				   ...
				   nbjets++;
		       	     ...
		       	     // 2nd Selection: on having at least 2 tight b-jets/event 
   ...
   cout << "================================================================================"    << endl;
   cout << " muon pT > 5GeV & |eta| < 2.4                            |   " <<  NEvents[0]        << endl;
   cout << "================================================================================"    << endl;
   cout << " number of muons/event > 3                               |   " <<  NEvents[1]        << endl;
   cout << "================================================================================"    << endl;
   cout << " 4 muon charge/event = 0                                 |   " <<  NEvents[2]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " leading, subleading muon pT > 20 & 10 GeV               |   " <<  NEvents[3]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " mu1mu2 , mu3mu4 pairs charge/event = 0 for comb. 1234   |   " <<  NEvents[4]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " DeltaR(mu1mu2, mu3mu4) > 0.02 for comb. 1234            |   " <<  NEvents[5]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " mass of mu1mu2 & mu3mu4/event > 4 GeV for comb. 1234    |   " <<  NEvents[6]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " mu1mu3 , mu2mu4 pairs charge/event = 0 for comb. 1324   |   " <<  NEvents[7]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " DeltaR(mu1mu3, mu2mu4) > 0.02 for comb. 1324            |   " <<  NEvents[8]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " mass of mu1mu3 & mu2mu4/event > 4 GeV for comb. 1324    |   " <<  NEvents[9]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " mu1mu4 , mu2mu3 pairs charge/event = 0 for comb. 1423   |   " <<  NEvents[10]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " DeltaR(mu1mu4, mu2mu3) > 0.02 for comb. 1423            |   " <<  NEvents[11]       << endl; 
   cout << "================================================================================"    << endl;
   cout << " mass of mu1mu4 & mu2mu3/event > 4 GeV for comb. 1423    |   " <<  NEvents[12]       << endl; 
   cout << "================================================================================"    << endl;
   cout << " Za, Zb masses, Za > 40 GeV & Zb > 12 GeV                |   " <<  NEvents[13]       << endl; 
   cout << "================================================================================"    << endl;
