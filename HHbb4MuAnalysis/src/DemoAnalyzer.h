...
// Sun Aug 29 22:24:43 2021 by ROOT version 6.18/04
// from TTree Delphes/Analysis tree
// found on file: /media/aya/LinuxSpace/MyWork_Final_Samples/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4205;
   static constexpr Int_t kMaxGenJet = 13;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxEFlowTrack = 224;
   static constexpr Int_t kMaxEFlowPhoton = 268;
   ...
   static constexpr Int_t kMaxMuonLoose = 7;
   static constexpr Int_t kMaxMuonTight = 7;
   ...
   DemoAnalyzer(TTree *tree=0);
   virtual ~DemoAnalyzer();
...
#ifdef DemoAnalyzer_cxx
DemoAnalyzer::DemoAnalyzer(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
	  
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs/gghhbb4Mu_final.root");
     ...
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs/ttbar.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs/ZZ4Mu.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs/ZZbb2Mu.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs/sm_ggToHTobb_NLO.root");
      
      if (!f || !f->IsOpen()) {
		
	 f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/gghhbb4Mu_final.root"); 
        // f = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/analysis/gghhbb4M_AllDiagrams_20210915.root");
	// f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/ttbar.root");
	// f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/ZZ4Mu.root");
	// f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/ZZbb2Mu.root");
	// f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/sm_ggToHTobb_NLO.root");
      }
...
Int_t DemoAnalyzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DemoAnalyzer::LoadTree(Long64_t entry)
{
...
void DemoAnalyzer::Init(TTree *tree)
{
...
void DemoAnalyzer::Show(Long64_t entry)
{
...
Int_t DemoAnalyzer::Cut(Long64_t entry)
{
